...
let musicall = [
    {
        ...
        img: "./assets/letmedown_slowly.jpg",
        link: "./assets/Let_me_down_slowly.mp3"
    },
    {
        id: "music-2",
        name: "Baby",
        artist: "Justin Bieber, Ludacris",
        img: "./assets/baby_song.jpg",
        link: "./assets/Baby_song.mp3"
    },
    {
        id: "music-3",
        name: "Shape Of You",
        artist: "Ed Sheeran",
        img: "./assets/Shapeof_you.jpg",
        link: "./assets/Shape_of_you.mp3"
    },
    {
        id: "music-4",
        name: "Safari",
        artist: "Serena",
        img: "./assetss/safari.jpg",
        link: "./assets/Safari_song.mp3"
    },
    {
        id: "music-5",
        name: "Sugar & Brownies",
        artist: "Dharia",
        img: "./assets/sugar_brownies.jpg",
        link: "./assets/Sugar_brownies_song.mp3"
    },
    {
        id: "music-6",
        name: "Hass Hass",
        artist: "Diljit Dosanjh",
        img: "./assets/hass_hass_song.jpg",
        link: "./assets/hass_hass_song.mp3"
    },
    {
        id: "music-7",
        name: "Admiring You",
        artist: "Karan Aujla",
        img: "./assets/admirin_you_song.jpg",
        link: "./assets/admirin_song.mp3"
    }
];
...
function loadMusic(indexNumb) {
    ...
    now_playing.textContent = "Playing music " + (indexNumb + 1) + " of " + musicall.length;
}
// play Music function
function playMusic() {
